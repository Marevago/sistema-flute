...
// Buscar todos os produtos da categoria 'Long Square'
...
<head>
    ...
    <style>
        ...
        /* ===== Layout dos cards igual à index.php ===== */
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Inicializações de página
            atualizarContadorCarrinho();
            inicializarFavoritos();
        });
        // Sincroniza badge do carrinho entre páginas/abas
                    ...
                    ?>
                        <div class="product-card">
                            ...
                            <div class="product-info">
                                ...
                                <?php 
                                  // Avaliação simulada estável por produto (igual index.php)
