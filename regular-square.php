...
// Buscar todos os produtos Regular Square
$queryAllRegularSquare = "SELECT * FROM produtos 
                         WHERE categoria = 'Regular Square' 
                         AND tipo = 'produto'
                         ORDER BY nome";
$stmtRegularSquare = $conn->prepare($queryAllRegularSquare);
$stmtRegularSquare->execute();
$regularSquareProducts = $stmtRegularSquare->fetchAll(PDO::FETCH_ASSOC);


// Get product details from database
$query = "SELECT * FROM produtos WHERE categoria = 'Regular Square' AND tipo = 'produto'";
$stmt = $conn->prepare($query);
$stmt->execute();
$regularSquareProduct = $stmt->fetch(PDO::FETCH_ASSOC);
?>
...
<body>
    ...
    <div class="main-container">
        <div class="category-header">
            <h1 class="category-title">Regular Square</h1>
            <p class="category-description">
                Nossa linha clássica de incensos Regular Square oferece uma ampla variedade de fragrâncias 
                tradicionais e místicas. Cada aroma é cuidadosamente selecionado e produzido para proporcionar 
                uma experiência única de bem-estar e harmonia.
            </p>
        </div>
