...
// Buscar todos os produtos da categoria 'Regular Square'
$queryRegularSquare = "SELECT * FROM produtos 
                   WHERE categoria = 'Regular Square' 
                   AND tipo = 'produto'
                   ORDER BY nome";
$stmtRegularSquare = $conn->prepare($queryRegularSquare);
$stmtRegularSquare->execute();
$regularSquareProducts = $stmtRegularSquare->fetchAll(PDO::FETCH_ASSOC);
...
<head>
    ...
    <title>Regular Square - Flute Incensos</title>
    ...
    <script>
        ...
        function pulseCartIcon() {
            ...
            void cart.offsetWidth; // reflow para reiniciar animação
            ...
            // Inicializa favoritos após montar os cards
...
<body>
    ...
    <div class="main-container">
        <main class="products-area">
            <div class="main-text2">
                <h2>Incensos Regular Square</h2>

                
                <div class="products-grid">
                    <?php foreach ($regularSquareProducts as $produto): 
                        // 1. Extrair variação para imagem
                        ...
                        // 2. Título padronizado reutilizável
                        $nomePadronizado = formatarTituloProduto($produto['categoria'], $produto['nome']);

                        // 3. Variação para caminho da imagem
                        $variacaoParaImagem = $variacaoApenas;
                        // 4. Link dinâmico para página de produto por ID
    ...
    <style>
      /* Ajustes locais para cards desta página para igualar à index */
    ...
    <script>
      // Stepper de quantidade (mesma lógica da index)
      (function(){
