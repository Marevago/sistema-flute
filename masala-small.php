...
function getImagePath($variacao) {
    ...
    $imagePath = "uploads/incensos/masala-small/{$imageName}.jpg";
...
<body>
    ...
    <div class="main-container">
        <div class="category-header">
            <h1 class="category-title">Masala Small Packet</h1>
            <p class="category-description">
                Nossa linha Masala Small Packet apresenta o tradicional incenso Nag Champa 
                em um formato compacto e econômico, mantendo toda a qualidade e aroma característicos.
            </p>
        </div>
