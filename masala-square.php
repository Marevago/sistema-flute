...
// Buscar todos os produtos da categoria 'Masala Square'
$queryMasalaSquare = "SELECT * FROM produtos 
                   WHERE categoria = 'Masala Square' 
                   AND tipo = 'produto'
                   ORDER BY nome";
$stmtMasalaSquare = $conn->prepare($queryMasalaSquare);
$stmtMasalaSquare->execute();
$masalaSquareProducts = $stmtMasalaSquare->fetchAll(PDO::FETCH_ASSOC);
...
<head>
    ...
    <title>Masala Square - Flute Incensos</title>
...
<body>
    ...
    <div class="main-container">
        <main class="products-area">
            <div class="main-text2">
                <h2>Incensos Masala Square</h2>

                
                <div class="products-grid">
                    <?php foreach ($masalaSquareProducts as $produto): 
                        // 1. Nome padronizado para exibição (reutilizável em qualquer página)
                        $nomePadronizado = formatarTituloProduto($produto['categoria'], $produto['nome']);

                        // 2. Preparar variação para o CAMINHO DA IMAGEM (mantém lógica anterior)
    ...
    <script>
      // Comportamento do stepper: incrementa/decrementa e garante mínimo de 1 (igual index.php)
      (function(){
