...
function getImagePath($variacao) {
    ...
    $imagePath = "uploads/incensos/masala-square/{$imageName}.jpg";
...
// Buscar todos os produtos Masala Square
$queryAllMasalaSquare = "SELECT * FROM produtos 
                        WHERE categoria = 'Masala Square' 
                        AND tipo = 'produto'
                        ORDER BY nome";
$stmtMasalaSquare = $conn->prepare($queryAllMasalaSquare);
...
<body>
    ...
    <div class="main-container">
        <div class="category-header">
            <h1 class="category-title">Masala Square</h1>
            <p class="category-description">
                Nossa linha Masala Square oferece incensos com fragrâncias diferenciadas e qualidade superior. 
                Cada aroma é cuidadosamente selecionado e produzido para proporcionar uma experiência única.
            </p>
        </div>
