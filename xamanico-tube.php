...
function getImagePath($variacao) {
    ...
    $imagePath = "uploads/incensos/xamanico-tube/{$imageName}.jpg";
...
// Buscar todos os produtos Xamânico Tube
$queryAllXamanico = "SELECT * FROM produtos 
                     WHERE categoria = 'Incenso Xamânico Tube' 
                     AND tipo = 'produto'
                     ORDER BY nome";
$stmtXamanico = $conn->prepare($queryAllXamanico);
...
<body>
    ...
    <div class="category-header">
        <h1 class="category-title">Xamânico Tube</h1>
        <p class="category-description">
            Nossa linha Xamânico Tube oferece incensos especiais em formato de tubo, 
            com fragrâncias poderosas e místicas para rituais e harmonização de ambientes.
        </p>
    </div>

        <div class="variations-grid">
            <?php foreach ($xamanicoProducts as $produto):                $nomeSemIncenso = str_replace('Incenso ', '', $produto['nome']); // Remove "Incenso " do nome
            ?>
